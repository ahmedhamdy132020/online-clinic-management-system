<?php
	...
	$dbPassword = '';
	$dbDatabase = '.';
	$appURI = 'onlineclinicmangsystem/app';
	$host = 'localhost';

	$adminConfig = array(
		'adminUsername' => "ahmed",
		'adminPassword' => "\$2y\$10\$phQcmjXQmHVFWdhZMU0aA.z1WSO/5zwbDAQRL26dyUZcq2mUq/FVq",
